	...
	<body>
		...
		<div id="show-item" class="content scaffold-show" role="main">
			...
			<ol class="property-list item">
				...
				<g:if test="${itemInstance?.amount}">
				<li class="fieldcontain">
					<span id="amount-label" class="property-label"><g:message code="item.amount.label" default="Amount" /></span>
					
						<span class="property-value" aria-labelledby="amount-label"><g:fieldValue bean="${itemInstance}" field="amount"/></span>
